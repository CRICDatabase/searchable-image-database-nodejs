...
rotasImagem.post("/api/v1/imagens/:id_imagem(\\d+)/aprovada", auth_middleware.login_required, ImagemController.approve_image);
rotasImagem.delete("/api/v1/imagens/:id_imagem(\\d+)/aprovada", auth_middleware.login_required, ImagemController.unapprove_image);
...
rotasImagem.post("/api/v1/imagens/:id_imagem/classificacoes", auth_middleware.login_required, SistemaController.not_implemented);
rotasImagem.post("/api/v1/imagens/:id_imagem/classificacao-celula/:id_usuario(\\d+)", auth_middleware.login_required, ImagemController.cadastrarClassificacaoDeCelula); // TODO Remove in v2
...
rotasImagem.post("/api/v1/imagens/:id_imagem/segmentacoes", auth_middleware.login_required, SistemaController.not_implemented);
rotasImagem.post("/api/v1/imagens/:id_imagem/segmentacao-celula/:id_usuario", auth_middleware.login_required, ImagemController.cadastrarSegmentacaoDeCelula); // TODO Remove in v2
